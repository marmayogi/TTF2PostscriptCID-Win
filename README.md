...
A conversion utility can be developed using 2nd and 3rd approaches. The 3rd approach is not only flexible over 2nd approach but also unicode support could be implemented.
